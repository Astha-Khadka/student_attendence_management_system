...
<div class="main-content">
    ...
    <div class="id-card" data-aos="fade-up" id="profile">
        ...
        <div class="id-actions" style="margin-top: 20px;">
            ...
            <a href="${pageContext.request.contextPath}/student-edit-profile" class="btn btn-secondary" style="background-color: #b0c4de; color: #2f4f4f; text-decoration: none; padding: 10px 15px; border-radius: 5px; margin-right: 10px;">
                <i class="fas fa-edit"></i> Edit Profile
            </a>
            <a href="${pageContext.request.contextPath}/student/contact" class="btn btn-secondary" style="background-color: #b0c4de; color: #2f4f4f; text-decoration: none; padding: 10px 15px; border-radius: 5px;">
    ...
    <section class="dashboard-container">
        ...
        <div class="grid">
            <div class="card" data-aos="fade-right" id="attendance">
                <div>
                    <h3 style="font-size: 22px; font-weight: 600; color: #4682b4; margin-bottom: 16px;">
                        <i class="fas fa-clipboard-check fa-lg"></i> Attendance
                    </h3>
                    ...
                    <p style="text-align: center; margin: 12px 0; font-size: 16px; color: #4B5563;">
                        <%= studentProfile.get("classesAttended") %>/<%= studentProfile.get("totalClasses") %> classes attended
                    </p>
                </div>
                <a href="${pageContext.request.contextPath}/student-attendance" class="btn" style="margin-top: auto;">
            ...
            <div class="card" data-aos="fade-up" id="notifications">
                <div>
                    <h3 style="font-size: 22px; font-weight: 600; color: #4682b4; margin-bottom: 16px; cursor: pointer;" onclick="toggleNotifications()">
                        <i class="fas fa-bell fa-lg"></i> Notifications 
                        <i class="fas fa-chevron-down" id="notif-icon"></i>
                    </h3>
                    <div class="notification-panel" id="notification-panel">
                        <ul class="notification-list">
                            ...
                            %>
                                <li><i class="fas fa-info-circle"></i> No new notifications</li>
                            <%
                                }
                            %>
                        </ul>
                ...
                <a href="${pageContext.request.contextPath}/student/notifications" class="btn" style="margin-top: auto;">
