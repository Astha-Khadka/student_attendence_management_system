...
<div style="text-align: center; padding: 50px 20px;">
    <h1 style="font-size: 3rem; color: #4CAF50; margin-bottom: 20px;">Register as Student</h1>
    <p style="font-size: 1.2rem; color: #555; margin-bottom: 30px;">Please fill out the form to register as a student.</p>
</div>
...
<div style="display: flex; justify-content: center; align-items: center; height: 60vh;">
    <div style="background-color: #fff; padding: 40px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); text-align: center; width: 100%; max-width: 400px;">
        <form action="registerStudent" method="post">
            ...
            <input type="submit" value="Register as Student" style="background-color: #007BFF; color: white; padding: 12px 20px; border-radius: 5px; font-size: 1rem; margin-top: 20px; cursor: pointer; border: none; transition: background-color 0.3s;">
        </form>
    </div>
</div>
